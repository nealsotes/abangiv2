...
namespace AbangiAPI.Migrations
{
    ...
    [Migration("20220916042811_UpdatedDbv1")]
    partial class UpdatedDbv1
    {
            ...
            modelBuilder.Entity("AbangiAPI.Models.Item", b =>
                {
                    ...
                    b.HasOne("AbangiAPI.Models.RentalMethod", "RentalMethod")
                        .WithMany()
                        .HasForeignKey("RentalMethodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
