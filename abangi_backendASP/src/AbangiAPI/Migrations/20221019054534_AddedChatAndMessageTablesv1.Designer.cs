...
namespace AbangiAPI.Migrations
{
    ...
    [Migration("20221019054534_AddedChatAndMessageTablesv1")]
    partial class AddedChatAndMessageTablesv1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbangiAPI.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AbangiAPI.Entities.User", b =>
                {
                    b.HasOne("AbangiAPI.Models.Chat", null)
                        .WithMany("Users")
            ...
            modelBuilder.Entity("AbangiAPI.Models.ChatApp.Message", b =>
                {
                    b.HasOne("AbangiAPI.Models.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
